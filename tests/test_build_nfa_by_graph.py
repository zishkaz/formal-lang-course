...
def test_check_is_nfa():
    two_cycles_graph = build_two_cycle_labeled_graph(first_cycle_size=4, second_cycle_size=4, edge_labels=("A", "B"))
...
def test_nfa_is_equivalent():
    ...
    expected_nfa.add_transitions(
        [(0, "A", 1), (1, "A", 2), (2, "A", 3), (3, "A", 0), (0, "B", 4), (4, "B", 5), (5, "B", 6), (6, "B", 0)]
    )
    ...
    two_cycles_graph = build_two_cycle_labeled_graph(first_cycle_size=3, second_cycle_size=3, edge_labels=("A", "B"))
