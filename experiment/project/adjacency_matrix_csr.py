...
def intersect_adjacency_matrices(
    first_matrix: AdjacencyMatrixCsr, second_matrix: AdjacencyMatrixCsr
):
    """
    Calculates tensor multiplication of two adjacency matrices.
    :return: Result matrix.
    """
    result = AdjacencyMatrixCsr()
...
def am_to_nfa(am: AdjacencyMatrixCsr):
    """
...
def make_front(
    start_state_indices,
    first_matrix: AdjacencyMatrixCsr,
    second_matrix: AdjacencyMatrixCsr,
) -> sparse.csr_matrix:
