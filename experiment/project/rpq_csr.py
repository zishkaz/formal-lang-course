...
from project.adjacency_matrix_csr import (
    AdjacencyMatrixCsr,
...
def rpq_tensor_csr(
    ...
    graph_matrix = AdjacencyMatrixCsr(nfa)
    query_matrix = AdjacencyMatrixCsr(dfa)
...
def rpq_bfs_csr(
    ...
    """
    am1 = AdjacencyMatrixCsr(build_nfa_by_graph(graph, start_nodes, final_nodes))
    am2 = AdjacencyMatrixCsr(regex_to_min_dfa(query))
